  ...
  override render() {
    ...
    const optionsList: {
      ...
      },
      {
        ...
        descKo:
          "문서 내용은 전혀 수정하지 않고, 어디에서도 쓰이지 않는 방치된 파일만 깔끔하게 제거합니다.",
        descEn: "Keeps document text untouched and only deletes unlinked, unused files.",
      ...
      {
        mode: "remove",
        labelKo: "사용하지 않는 링크 및 파일 완전히 삭제",
        labelEn: "Remove Unused Links and Files",
        descKo: "사용하지 않는 파일 및 링크를 완전히 삭제합니다.",
        descEn: "Completely deletes unused links and files.",
        icon: "fa-trash-can",
        tagKo: "주의",
        tagEn: "Caution",
      },
